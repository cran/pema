...
public:
  ...
  inline std::string model_name() const final { return "model_horseshoe_MA_ml_noint"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_horseshoe_MA_ml_noint_namespace::log_prob";
(void) function__;  // suppress unused var warning
