...
#include "stanExports_lasso_MA_noint.h"

RCPP_MODULE(stan_fit4lasso_MA_noint_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_lasso_MA_noint")
