...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lasso_MA_noint");
    reader.add_event(59, 57, "end", "model_lasso_MA_noint");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lasso_MA_noint
  : public stan::model::model_base_crtp<model_lasso_MA_noint> {
private:
        int N;
        vector_d Y;
        vector_d se;
...
typedef model_lasso_MA_noint_namespace::model_lasso_MA_noint stan_model;
#ifndef USING_R
