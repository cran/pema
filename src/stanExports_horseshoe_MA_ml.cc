...
#include "stanExports_horseshoe_MA_ml.h"

RCPP_MODULE(stan_fit4horseshoe_MA_ml_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_horseshoe_MA_ml")
