...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_horseshoe_MA_noint");
    reader.add_event(88, 86, "end", "model_horseshoe_MA_noint");
    return reader;
}
...
class model_horseshoe_MA_noint
  : public stan::model::model_base_crtp<model_horseshoe_MA_noint> {
private:
        int N;
        vector_d Y;
        vector_d se;
...
public:
    ...
    std::string model_name() const {
        return "model_horseshoe_MA_noint";
    }
...
typedef model_horseshoe_MA_noint_namespace::model_horseshoe_MA_noint stan_model;
#ifndef USING_R
