...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lasso_prior");
    reader.add_event(15, 13, "end", "model_lasso_prior");
    return reader;
}
#include <stan_meta_header.hpp>
class model_lasso_prior
  : public stan::model::model_base_crtp<model_lasso_prior> {
private:
        double df;
        double scale;
public:
...
typedef model_lasso_prior_namespace::model_lasso_prior stan_model;
#ifndef USING_R
