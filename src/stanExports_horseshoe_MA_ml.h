...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_horseshoe_MA_ml");
    reader.add_event(108, 106, "end", "model_horseshoe_MA_ml");
    return reader;
}
...
class model_horseshoe_MA_ml
  : public stan::model::model_base_crtp<model_horseshoe_MA_ml> {
private:
        int N;
        vector_d Y;
        vector_d se;
...
typedef model_horseshoe_MA_ml_namespace::model_horseshoe_MA_ml stan_model;
#ifndef USING_R
