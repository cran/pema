...
namespace model_horseshoe_MA_ml_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 59, column 2 to column 23)",
                                                      ...
                                                      " (in 'string', line 102, column 2 to column 56)",
                                                      " (in 'string', line 103, column 2 to column 31)",
                                                      " (in 'string', line 104, column 2 to column 26)",
                                                      " (in 'string', line 105, column 2 to column 26)",
                                                      " (in 'string', line 74, column 11 to column 12)",
                                                      " (in 'string', line 74, column 4 to column 33)",
                                                      ...
                                                      " (in 'string', line 85, column 2 to column 48)",
                                                      " (in 'string', line 86, column 2 to line 87, column 19)",
                                                      " (in 'string', line 88, column 2 to column 67)",
                                                      " (in 'string', line 93, column 2 to line 94, column 41)",
                                                      " (in 'string', line 95, column 2 to line 96, column 41)",
                                                      " (in 'string', line 97, column 2 to column 36)",
                                                      " (in 'string', line 98, column 2 to column 36)",
                                                      ...
                                                      " (in 'string', line 57, column 18 to column 21)",
                                                      " (in 'string', line 57, column 9 to column 12)",
                                                      " (in 'string', line 58, column 18 to column 21)",
                                                      " (in 'string', line 59, column 18 to column 21)",
...
class model_horseshoe_MA_ml final : public model_base_crtp<model_horseshoe_MA_ml> {
private:
  int N;
  ...
  int M_2;
  std::vector<int> J_2;
  Eigen::Matrix<double, -1, 1> Z_2_1;
  int prior_only;
  Eigen::Matrix<double, -1, 1> means_X;
  Eigen::Matrix<double, -1, 1> sds_X;
 
public:
  ~model_horseshoe_MA_ml() { }
  
  inline std::string model_name() const final { return "model_horseshoe_MA_ml"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = %%NAME%%3 %%VERSION%%", "stancflags = "};
  }
  
  
  model_horseshoe_MA_ml(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_horseshoe_MA_ml_namespace::model_horseshoe_MA_ml";
    ...
    try {
      ...
      current_statement__ = 60;
      assign(J_2, nil_index_list(), context__.vals_i("J_2"),
        "assigning variable J_2");
      current_statement__ = 60;
      for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
        current_statement__ = 60;
        current_statement__ = 60;
        check_greater_or_equal(function__, "J_2[sym1__]", J_2[(sym1__ - 1)],
                               1);}
      ...
      context__.validate_dims("data initialization","Z_2_1","double",
          context__.to_vec(N));
      Z_2_1 = Eigen::Matrix<double, -1, 1>(N);
      stan::math::fill(Z_2_1, std::numeric_limits<double>::quiet_NaN());
      
      {
        std::vector<local_scalar_t__> Z_2_1_flat__;
        current_statement__ = 62;
        assign(Z_2_1_flat__, nil_index_list(), context__.vals_r("Z_2_1"),
          "assigning variable Z_2_1_flat__");
        current_statement__ = 62;
        pos__ = 1;
        current_statement__ = 62;
        for (int sym1__ = 1; sym1__ <= N; ++sym1__) {
          current_statement__ = 62;
          assign(Z_2_1, cons_list(index_uni(sym1__), nil_index_list()),
            Z_2_1_flat__[(pos__ - 1)], "assigning variable Z_2_1");
          current_statement__ = 62;
          pos__ = (pos__ + 1);}
      }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_horseshoe_MA_ml_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      sd_2 = Eigen::Matrix<local_scalar_t__, -1, 1>(M_2);
      stan::math::fill(sd_2, DUMMY_VAR__);
      
      current_statement__ = 8;
      sd_2 = in__.vector(M_2);
      current_statement__ = 8;
      for (int sym1__ = 1; sym1__ <= M_2; ++sym1__) {
        current_statement__ = 8;
        if (jacobian__) {
          current_statement__ = 8;
          assign(sd_2, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(sd_2[(sym1__ - 1)], 0, lp__),
            "assigning variable sd_2");
        } else {
          current_statement__ = 8;
          assign(sd_2, cons_list(index_uni(sym1__), nil_index_list()),
            stan::math::lb_constrain(sd_2[(sym1__ - 1)], 0),
            "assigning variable sd_2");
        }}
      std::vector<Eigen::Matrix<local_scalar_t__, -1, 1>> z_2;
      z_2 = std::vector<Eigen::Matrix<local_scalar_t__, -1, 1>>(M_2, Eigen::Matrix<local_scalar_t__, -1, 1>(N_2));
      stan::math::fill(z_2, DUMMY_VAR__);
      
      current_statement__ = 9;
      for (int sym1__ = 1; sym1__ <= M_2; ++sym1__) {
        current_statement__ = 9;
        assign(z_2, cons_list(index_uni(sym1__), nil_index_list()),
          in__.vector(N_2), "assigning variable z_2");}
      ...
      r_2_1 = Eigen::Matrix<local_scalar_t__, -1, 1>(N_2);
      ...
      assign(r_2_1, nil_index_list(), multiply(sd_2[(1 - 1)], z_2[(1 - 1)]),
          ...
          (pow(scale_slab, 2) * hs_slab), pstream__), "assigning variable b");
      {
        ...
        if (logical_negation(prior_only)) {
          ...
          assign(mu, nil_index_list(), add(Int_c, multiply(X, b)),
        ...
        lp_accum__.add(student_t_lpdf<false>(Int_c, 3, 0.1, 2.5));
        ...
        lp_accum__.add(
          (student_t_lpdf<false>(sd_2, 3, 0, 2.5) -
            (1 * student_t_lccdf(0, 3, 0, 2.5))));
        current_statement__ = 35;
        lp_accum__.add(std_normal_lpdf<false>(z_1[(1 - 1)]));
        current_statement__ = 36;
        lp_accum__.add(std_normal_lpdf<false>(z_2[(1 - 1)]));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_horseshoe_MA_ml_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
    ...
    try {
      ...
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        ...
        assign(hs_local, cons_list(index_uni(sym1__), nil_index_list()),
          ...
          "assigning variable hs_local");}
      double Int_c;
      Int_c = std::numeric_limits<double>::quiet_NaN();
      ...
      for (int sym1__ = 1; sym1__ <= M_1; ++sym1__) {
        ...
        assign(z_1, cons_list(index_uni(sym1__), nil_index_list()),
          in__.vector(N_1), "assigning variable z_1");}
      Eigen::Matrix<double, -1, 1> sd_2;
      sd_2 = Eigen::Matrix<double, -1, 1>(M_2);
      stan::math::fill(sd_2, std::numeric_limits<double>::quiet_NaN());
      ...
      for (int sym1__ = 1; sym1__ <= M_2; ++sym1__) {
        ...
        assign(sd_2, cons_list(index_uni(sym1__), nil_index_list()),
          stan::math::lb_constrain(sd_2[(sym1__ - 1)], 0),
          "assigning variable sd_2");}
      std::vector<Eigen::Matrix<double, -1, 1>> z_2;
      z_2 = std::vector<Eigen::Matrix<double, -1, 1>>(M_2, Eigen::Matrix<double, -1, 1>(N_2));
      stan::math::fill(z_2, std::numeric_limits<double>::quiet_NaN());
      ...
      r_2_1 = Eigen::Matrix<double, -1, 1>(N_2);
      stan::math::fill(r_2_1, std::numeric_limits<double>::quiet_NaN());
      
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        vars__.emplace_back(zb[(sym1__ - 1)]);}
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        vars__.emplace_back(hs_local[(sym1__ - 1)]);}
      vars__.emplace_back(Int_c);
      ...
      for (int sym1__ = 1; sym1__ <= M_2; ++sym1__) {
        vars__.emplace_back(sd_2[(sym1__ - 1)]);}
      for (int sym1__ = 1; sym1__ <= N_2; ++sym1__) {
        for (int sym2__ = 1; sym2__ <= M_2; ++sym2__) {
          vars__.emplace_back(z_2[(sym2__ - 1)][(sym1__ - 1)]);}}
      ...
      if (emit_transformed_parameters__) {
        ...
        for (int sym1__ = 1; sym1__ <= N_2; ++sym1__) {
          vars__.emplace_back(r_2_1[(sym1__ - 1)]);}
      } 
      ...
      Intercept = (Int_c - sum(elt_multiply(b, elt_divide(means_X, sds_X))));
      ...
      double tau2_w;
      tau2_w = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 18;
      tau2_w = pow(sd_1[(1 - 1)], 2);
      double tau2_b;
      tau2_b = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 19;
      tau2_b = pow(sd_2[(1 - 1)], 2);
      vars__.emplace_back(Intercept);
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        vars__.emplace_back(betas[(sym1__ - 1)]);}
      vars__.emplace_back(tau2_w);
      vars__.emplace_back(tau2_b);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      
      {
        ...
        current_statement__ = 8;
        assign(sd_2_flat__, nil_index_list(), context__.vals_r("sd_2"),
          "assigning variable sd_2_flat__");
        current_statement__ = 8;
        pos__ = 1;
        current_statement__ = 8;
        for (int sym1__ = 1; sym1__ <= M_2; ++sym1__) {
          current_statement__ = 8;
          assign(sd_2, cons_list(index_uni(sym1__), nil_index_list()),
            sd_2_flat__[(pos__ - 1)], "assigning variable sd_2");
          current_statement__ = 8;
          pos__ = (pos__ + 1);}
      }
      Eigen::Matrix<double, -1, 1> sd_2_free__;
      sd_2_free__ = Eigen::Matrix<double, -1, 1>(M_2);
      stan::math::fill(sd_2_free__, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 8;
      for (int sym1__ = 1; sym1__ <= M_2; ++sym1__) {
        current_statement__ = 8;
        assign(sd_2_free__, cons_list(index_uni(sym1__), nil_index_list()),
          stan::math::lb_free(sd_2[(sym1__ - 1)], 0),
          "assigning variable sd_2_free__");}
      std::vector<Eigen::Matrix<double, -1, 1>> z_2;
      z_2 = std::vector<Eigen::Matrix<double, -1, 1>>(M_2, Eigen::Matrix<double, -1, 1>(N_2));
      stan::math::fill(z_2, std::numeric_limits<double>::quiet_NaN());
      
      {
        ...
        current_statement__ = 9;
        assign(z_2_flat__, nil_index_list(), context__.vals_r("z_2"),
          "assigning variable z_2_flat__");
        current_statement__ = 9;
        pos__ = 1;
        current_statement__ = 9;
        for (int sym1__ = 1; sym1__ <= N_2; ++sym1__) {
          ...
          for (int sym2__ = 1; sym2__ <= M_2; ++sym2__) {
            ...
            assign(z_2,
              cons_list(index_uni(sym2__),
                cons_list(index_uni(sym1__), nil_index_list())),
              z_2_flat__[(pos__ - 1)], "assigning variable z_2");
            current_statement__ = 9;
            pos__ = (pos__ + 1);}}
      }
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
      ...
      for (int sym1__ = 1; sym1__ <= M_2; ++sym1__) {
        vars__.emplace_back(sd_2_free__[(sym1__ - 1)]);}
      for (int sym1__ = 1; sym1__ <= M_2; ++sym1__) {
        for (int sym2__ = 1; sym2__ <= N_2; ++sym2__) {
          vars__.emplace_back(z_2[(sym1__ - 1)][(sym2__ - 1)]);}}
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
  ...
  inline void get_dims(std::vector<std::vector<size_t>>& dimss__) const {
    ...
    dimss__.emplace_back(std::vector<size_t>{static_cast<size_t>(M_2)});
    ...
    dimss__.emplace_back(std::vector<size_t>{static_cast<size_t>(N_2)});
  ...
  inline void constrained_param_names(
    ...
    for (int sym1__ = 1; sym1__ <= M_2; ++sym1__) {
      {
        param_names__.emplace_back(std::string() + "sd_2" + '.' + std::to_string(sym1__));
      }}
    for (int sym1__ = 1; sym1__ <= N_2; ++sym1__) {
      {
        for (int sym2__ = 1; sym2__ <= M_2; ++sym2__) {
          {
            param_names__.emplace_back(std::string() + "z_2" + '.' + std::to_string(sym2__) + '.' + std::to_string(sym1__));
          }}
      }}
    if (emit_transformed_parameters__) {
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
      ...
      for (int sym1__ = 1; sym1__ <= N_2; ++sym1__) {
        {
          param_names__.emplace_back(std::string() + "r_2_1" + '.' + std::to_string(sym1__));
        }}
    }
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"zb\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"hs_local\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"Int_c\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"hs_global\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"hs_slab\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sd_1\",\"type\":{\"name\":\"vector\",\"length\":" << M_1 << "},\"block\":\"parameters\"},{\"name\":\"z_1\",\"type\":{\"name\":\"array\",\"length\":" << M_1 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_1 << "}},\"block\":\"parameters\"},{\"name\":\"sd_2\",\"type\":{\"name\":\"vector\",\"length\":" << M_2 << "},\"block\":\"parameters\"},{\"name\":\"z_2\",\"type\":{\"name\":\"array\",\"length\":" << M_2 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_2 << "}},\"block\":\"parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"transformed_parameters\"},{\"name\":\"r_1_1\",\"type\":{\"name\":\"vector\",\"length\":" << N_1 << "},\"block\":\"transformed_parameters\"},{\"name\":\"r_2_1\",\"type\":{\"name\":\"vector\",\"length\":" << N_2 << "},\"block\":\"transformed_parameters\"},{\"name\":\"Intercept\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"betas\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"generated_quantities\"},{\"name\":\"tau2_w\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"tau2_b\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_horseshoe_MA_ml_namespace::model_horseshoe_MA_ml;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_horseshoe_MA_ml_namespace::profiles__;
}
#endif
#endif
