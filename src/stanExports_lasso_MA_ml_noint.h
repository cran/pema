...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 65, column 4 to column 25)",
                                                      " (in 'string', line 68, column 6 to column 67)",
                                                      ...
                                                      " (in 'string', line 73, column 2 to column 69)",
                                                      " (in 'string', line 74, column 2 to column 51)",
                                                      " (in 'string', line 75, column 2 to line 76, column 41)",
                                                      " (in 'string', line 77, column 2 to line 78, column 41)",
                                                      " (in 'string', line 79, column 2 to column 36)",
...
class model_lasso_MA_ml_noint final : public model_base_crtp<model_lasso_MA_ml_noint> {
private:
  int N;
...
public:
  ...
  inline std::string model_name() const final { return "model_lasso_MA_ml_noint"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_lasso_MA_ml_noint_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"lasso_inv_lambda\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sd_1\",\"type\":{\"name\":\"vector\",\"length\":" << M_1 << "},\"block\":\"parameters\"},{\"name\":\"z_1\",\"type\":{\"name\":\"array\",\"length\":" << M_1 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_1 << "}},\"block\":\"parameters\"},{\"name\":\"sd_2\",\"type\":{\"name\":\"vector\",\"length\":" << M_2 << "},\"block\":\"parameters\"},{\"name\":\"z_2\",\"type\":{\"name\":\"array\",\"length\":" << M_2 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_2 << "}},\"block\":\"parameters\"},{\"name\":\"r_1_1\",\"type\":{\"name\":\"vector\",\"length\":" << N_1 << "},\"block\":\"transformed_parameters\"},{\"name\":\"r_2_1\",\"type\":{\"name\":\"vector\",\"length\":" << N_2 << "},\"block\":\"transformed_parameters\"},{\"name\":\"betas\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"generated_quantities\"},{\"name\":\"tau2_w\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"tau2_b\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_lasso_MA_ml_noint_namespace::model_lasso_MA_ml_noint;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_lasso_MA_ml_noint_namespace::profiles__;
}
#endif
#endif
