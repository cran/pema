...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lasso_MA_ml");
    reader.add_event(92, 90, "end", "model_lasso_MA_ml");
    return reader;
}
...
class model_lasso_MA_ml
  : public stan::model::model_base_crtp<model_lasso_MA_ml> {
private:
        int N;
        vector_d Y;
        vector_d se;
...
typedef model_lasso_MA_ml_namespace::model_lasso_MA_ml stan_model;
#ifndef USING_R
