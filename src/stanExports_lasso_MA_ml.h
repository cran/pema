...
namespace model_lasso_MA_ml_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 47, column 2 to column 13)",
                                                      " (in 'string', line 49, column 2 to column 33)",
                                                      " (in 'string', line 51, column 2 to column 28)",
                                                      ...
                                                      " (in 'string', line 66, column 4 to column 33)",
                                                      " (in 'string', line 69, column 6 to column 67)",
                                                      " (in 'string', line 67, column 19 to line 70, column 5)",
                                                      " (in 'string', line 67, column 4 to line 70, column 5)",
                                                      " (in 'string', line 71, column 4 to column 38)",
                                                      " (in 'string', line 64, column 19 to line 72, column 3)",
                                                      " (in 'string', line 64, column 2 to line 72, column 3)",
                                                      " (in 'string', line 74, column 2 to column 69)",
                                                      " (in 'string', line 75, column 2 to column 48)",
                                                      " (in 'string', line 76, column 2 to column 51)",
                                                      " (in 'string', line 77, column 2 to line 78, column 41)",
                                                      " (in 'string', line 79, column 2 to line 80, column 41)",
                                                      ...
                                                      " (in 'string', line 32, column 19 to column 20)",
                                                      ...
                                                      " (in 'string', line 38, column 19 to column 20)",
                                                      ...
                                                      " (in 'string', line 51, column 18 to column 21)",
                                                      " (in 'string', line 52, column 18 to column 21)",
                                                      " (in 'string', line 52, column 9 to column 12)",
                                                      " (in 'string', line 53, column 18 to column 21)",
                                                      " (in 'string', line 54, column 18 to column 21)",
...
class model_lasso_MA_ml final : public model_base_crtp<model_lasso_MA_ml> {
private:
  int N;
...
public:
  ...
  inline std::string model_name() const final { return "model_lasso_MA_ml"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = %%NAME%%3 %%VERSION%%", "stancflags = "};
  }
  
  
  model_lasso_MA_ml(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_lasso_MA_ml_namespace::model_lasso_MA_ml";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_lasso_MA_ml_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_lasso_MA_ml_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"Int_c\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lasso_inv_lambda\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sd_1\",\"type\":{\"name\":\"vector\",\"length\":" << M_1 << "},\"block\":\"parameters\"},{\"name\":\"z_1\",\"type\":{\"name\":\"array\",\"length\":" << M_1 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_1 << "}},\"block\":\"parameters\"},{\"name\":\"sd_2\",\"type\":{\"name\":\"vector\",\"length\":" << M_2 << "},\"block\":\"parameters\"},{\"name\":\"z_2\",\"type\":{\"name\":\"array\",\"length\":" << M_2 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << N_2 << "}},\"block\":\"parameters\"},{\"name\":\"r_1_1\",\"type\":{\"name\":\"vector\",\"length\":" << N_1 << "},\"block\":\"transformed_parameters\"},{\"name\":\"r_2_1\",\"type\":{\"name\":\"vector\",\"length\":" << N_2 << "},\"block\":\"transformed_parameters\"},{\"name\":\"Intercept\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"betas\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"generated_quantities\"},{\"name\":\"tau2_w\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"},{\"name\":\"tau2_b\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = model_lasso_MA_ml_namespace::model_lasso_MA_ml;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_lasso_MA_ml_namespace::profiles__;
}
#endif
#endif
